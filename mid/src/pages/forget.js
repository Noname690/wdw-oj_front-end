...
export default function Change_pwd() {
    ...
    return<div className='wrapper'>
        ...
        <QueueAnim
            ...
            {show ? [
                <div className='frame_forget' key="demo1">
                    <Form {...layout} className='login-form'>
                        ...
                        <FormItem label="ID">
                            <Input placeholder="Please enter your account number" maxLength={10}  onChange={(event)=>{
                                window.localStorage.id = event.target.value
                            }}/>
                        </FormItem>
