        ...
        <Form className='login-form'
              ...
              initialValues={{ remember: true }}>
                ...
                <FormItem  {...layout} label="password">
                        <Input placeholder="Please enter your password." maxLength={10} type={"password"} onChange={(event)=>{
                ...
                <FormItem  {...tailLayout} style={{textAlign:"left"}}>
                        ...
                        <Button style={{ left:"5%" }} title={'Forgot password'} type="dashed" shape="circle" icon={<QuestionCircleTwoTone />} onClick={()=> {
                                history.push('forget')
                        }}/>
                </FormItem>
        </Form>
